...
if __name__ == "__main__":
    ...
    import json
    json_path = '/hpc_stor03/sjtu_home/zhisheng.zheng/tencent/reverbs/eval.json'
    ...
    for idx in range(simu_num):
        config, rir = multi_channel_array(simu_config)
        config['fname'] = f'rir_{idx}.npy'
        configs.append(config)
        np.save(f'/hpc_stor03/sjtu_home/zhisheng.zheng/tencent/reverbs/eval/rir_{idx}.npy', rir)
